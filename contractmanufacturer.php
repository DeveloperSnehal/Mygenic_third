			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						<!-- Sec Title -->
						<div class="sec-title">
							<h2 style="font-size: 25px; color:#ed6f1e">TOP PHARMACEUTICAL CONTRACT<br> MANUFACTURER IN INDIA</h2>
							<div class="separator"></div>
						</div>
						<!-- Hospital Tabs-->
			...
			<div class="row clearfix">
				...
				<div class="content-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						<!-- Sec Title -->
						<div class="sec-title">
							<h2 style="font-size: 25px; color:#ed6f1e">WHY TO CHOOSE US?</h2>
							<div class="separator"></div>
						</div>
						<!-- Hospital Tabs-->
						<div class="hospital-info-tabs">
