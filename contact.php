    ...
    <!--End Page Title-->
	    ...
	    <section class="faq-form-section">
            <div class="auto-container">
                ...
                <div class="faq-form">
                    <!--Faq Form-->
                    <form method="post" action="http://expert-themes.com/html/meditech/blog.html">
        ...
        <div class="outer-container">
			<div class="auto-container clearfix">
				<div class="map-content">
					...
					<h2>Contact Info</h2>
					<ul class="info-list">
						<li><span class="icon fas fa-envelope"></span>info@mygenichealthcare.com</li>
						<li><span class="icon fas fa-phone-volume"></span>+91 9867592446</li>
						<li><span class="icon fas fa-map-marker-alt"></span>Sector 35 Dolphin Platinum Kamothe, Navi Mumbai, Maharashtra, India</li>
					</ul>
            ...
            <div class="map-outer">
				...
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.9288111479877!2d73.08528887396831!3d19.022858353641137!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7e9d7de2988b5%3A0x65f0babb8b111ed6!2sDolphin%20Platinum!5e0!3m2!1snl!2snl!4v1687873292815!5m2!1snl!2snl" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </section>
